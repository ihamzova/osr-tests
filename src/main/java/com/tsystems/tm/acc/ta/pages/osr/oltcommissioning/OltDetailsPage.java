...
public class OltDetailsPage {
    ...
    public static final By UPLINK_MODIFICATION_OPTION_LOCATOR = byXpath("/html/body/app-root/div/div/div/app-detail/app-olt-detail/div[3]/div[1]/table/tbody/tr/td[10]/div/div/div/div[2]");
    //byQaData("button-uplink-configuration");
    ...
    @Step("Modify uplink")
    public UplinkConfigurationPage startUplinkModification() {
        $(UPLINKS_DETAILS_TAB_LOCATOR).waitUntil(appears, MAX_LATENCY_FOR_ELEMENT_APPEARS).click();
        ...
        $(UPLINK_MODIFICATION_OPTION_LOCATOR).click();
        //$(UPLINK_CONFIGURATION_BUTTON_LOCATOR).waitUntil(appears, MAX_LATENCY_FOR_ELEMENT_APPEARS).click();
        return new UplinkConfigurationPage();
    }
