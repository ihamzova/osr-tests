...
public class UplinkResourceInventoryStub extends AbstractStubMapping {
    ...
    public MappingBuilder getUplinks(String endSz, List<String> states, String manufacturer) {
        return get(urlPathEqualTo(UPLINK_RESOURCE_INVENTORY_URL))
                ...
                .withName("getUplinks")
                .willReturn(aDefaultResponseWithBody(serialize(new UplinkResourceInventoryMapper().getUplinks(endSz, states, manufacturer)), HTTP_CODE_OK_200))
                .atPriority(0);
    }

    public MappingBuilder findAndImportUplinks(String endSz, List<String> states, String manufacturer) {
