...
public class UplinkResourceInventoryStub extends AbstractStubMapping {
  ...
  public MappingBuilder getUplinks(String endSz, String state1, String state2, String state3, String manufacturer) {
    return get(urlPathEqualTo(UPLINK_RESOURCE_INVENTORY_URL))
            ...
            .withName("getUplinks")
            .willReturn(aDefaultResponseWithBody(serialize(new UplinkResourceInventoryMapper().getUplinks(endSz, state1, state2, state3, manufacturer)), HTTP_CODE_OK_200))
            .atPriority(0);
  }

  public MappingBuilder findAndImportUplinks(String endSz, String state1, String state2, String state3, String manufacturer) {
